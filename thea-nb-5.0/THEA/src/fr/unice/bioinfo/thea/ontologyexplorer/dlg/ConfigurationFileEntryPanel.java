...
public class ConfigurationFileEntryPanel extends JPanel {
    ...
    public ConfigurationFileEntryPanel(String filePath) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setLayout(new FormLayout(new ColumnSpec[] {
                ...
                new ColumnSpec(ColumnSpec.FILL, Sizes.dluX(100),
        ...
        // ---- msgLbl ----
        msgLbl.setText(bundle.getString("LBL_ConfigurationFileEntryPanel_Msg"));// NOI18N
    ...
    private void performBroserBtnAction(ActionEvent e) {
        ...
        pathField.setText(file.getAbsolutePath().trim());
    }
