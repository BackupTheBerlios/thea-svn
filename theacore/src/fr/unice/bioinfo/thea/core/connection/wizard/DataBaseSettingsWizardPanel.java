...
public class DataBaseSettingsWizardPanel implements WizardDescriptor.Panel{
    ...
    public DataBaseSettingsWizardPanel(ConnectionDialogDescriptor loadOntologyDialogDescriptor){
        this.loadOntologyDialogDescriptor = loadOntologyDialogDescriptor;
    }
    
    private ConnectionDialogDescriptor loadOntologyDialogDescriptor;
