...
/**
 * Iterator on the sequence of panels used by the Load 
 * Ontology Wizard.
 * @author SAÏD, EL KASMI.
 */
public class LoadOntologyPanesIter implements WizardDescriptor.Iterator {
     ...
     */
    public String name() {
        return NbBundle.getMessage(LoadOntologyPanesIter.class, "LBL_WizardSteps_X_OF_Y",
    ...
    protected WizardDescriptor.Panel[] buildPanels() {
        return new WizardDescriptor.Panel[] {
                new DataBaseSettingsWizardPanel(loadOntologyDialogDescriptor),
                new UserSettingsWizardPanel(loadOntologyDialogDescriptor) };
    }
    
    // Give a name to each step
    // try to use Bundles here
    protected String[] buildSteps(){
        return new String[]{"DataBase Settings",
                "User Settings"};
    }
    ...
    /**
     * @param loadOntologyDialogDescriptor The loadOntologyDialogDescriptor to set.
     */
    public void setLoadOntologyDialogDescriptor(
