package fr.unice.bioinfo.thea.ontologyexplorer.db.util;
...
public class DriverListUtil {
    ...
    static {
        ...
        urls
                .add("jdbc:informix-sqli://<HOST>:<PORT>/<DB>:INFORMIXSERVER=<SERVER_NAME>");

        names.add("Informix Dynamic Server (DataDirect Connect for JDBC)");
        drivers.add("com.ddtek.jdbc.informix.InformixDriver");
        urls
                .add("jdbc:datadirect:informix://<HOST>:<PORT>;informixServer=<SERVER_NAME>;databaseName=<DB>");
        ...
        urls
                .add("jdbc:datadirect:sqlserver://<HOST>:<PORT>[;databaseName=<DB>]");
        ...
        urls
                .add("jdbc:microsoft:sqlserver://<HOST>:<PORT>[;DatabaseName=<DB>]");
        ...
        // Following four entries for drivers to be included in Java Studio
        // Enterprise 7 (Bow)
        ...
        urls
                .add("jdbc:sun:db2://server_name:portNumber;databaseName=DATABASENAME");

        names.add("Oracle Driver");
        drivers.add("com.sun.sql.jdbc.oracle.OracleDriver");
        urls
                .add("jdbc:sun:oracle://server_name[:portNumber][;SID=DATABASENAME]");
