 ...
 */
public class ResourceNodeInstancesEditor extends TopComponent {
     ...
     */
    public ResourceNodeInstancesEditor(Node node) {
        super();
    ...
    private JPanel createMainPanel() {
        ...
        TableSorter sorter = new TableSorter(
                new ResourceNodeInstancesTableModel(this.node));
