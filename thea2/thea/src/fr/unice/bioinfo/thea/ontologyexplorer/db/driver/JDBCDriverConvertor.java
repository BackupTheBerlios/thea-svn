 ...
 */
public class JDBCDriverConvertor implements Environment.Provider,
    ...
    public Object instanceCreate() throws java.io.IOException,
        ...
        synchronized (this) {
            ...
            try {
                ...
                InputSource is = new org.xml.sax.InputSource(holder
                        .getPrimaryFile().getInputStream());
                is.setSystemId(holder.getPrimaryFile().getURL()
                        .toExternalForm());
